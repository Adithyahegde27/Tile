...
const AboutUs = () => {
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-slate-900 pt-16">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-violet-600 to-violet-600 dark:from-violet-700 dark:to-violet-700 py-20 overflow-hidden">
      ...
      <div className="py-16 bg-white dark:bg-slate-800">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Mission */}
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/30 dark:to-violet-900/30 p-8 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
            ...
            {/* Vision */}
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-900/30 dark:to-purple-900/30 p-8 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
      ...
      <div className="py-16 bg-gray-50 dark:bg-slate-800">
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className="bg-white dark:bg-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="100">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Premium Quality</h3>
            ...
            {/* Feature 2 */}
            <div className="bg-white dark:bg-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="200">
              <div className="w-14 h-14 bg-violet-100 dark:bg-violet-900/50 rounded-xl flex items-center justify-center mb-4">
                <FaShieldAlt className="text-2xl text-violet-600 dark:text-violet-400" />
              </div>
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Expert Guidance</h3>
              <p className="text-slate-600 dark:text-slate-300 text-sm">
            ...
            {/* Feature 3 */}
            <div className="bg-white dark:bg-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="300">
              <div className="w-14 h-14 bg-purple-100 dark:bg-purple-900/50 rounded-xl flex items-center justify-center mb-4">
                <FaClock className="text-2xl text-purple-600 dark:text-purple-400" />
              </div>
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Fast Delivery</h3>
              <p className="text-slate-600 dark:text-slate-300 text-sm">
            ...
            {/* Feature 4 */}
            <div className="bg-white dark:bg-slate-700 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300" data-aos="fade-up" data-aos-delay="400">
              <div className="w-14 h-14 bg-violet-100 dark:bg-violet-900/50 rounded-xl flex items-center justify-center mb-4">
                <FaUsers className="text-2xl text-violet-600 dark:text-violet-400" />
              </div>
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">Happy Customers</h3>
              <p className="text-slate-600 dark:text-slate-300 text-sm">
      ...
      {/* Stats Section */}
      <div className="py-16 bg-gradient-to-r from-purple-600 to-violet-600 dark:from-purple-700 dark:to-violet-700">
        <div className="container">
      ...
      <div className="py-16 bg-white dark:bg-slate-800">
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Testimonial 1 */}
            <div className="bg-gray-50 dark:bg-slate-700 p-6 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-slate-800 dark:text-white">Rahul Sharma</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400">Homeowner</p>
                </div>
              </div>
            </div>
            
            {/* Testimonial 2 */}
            <div className="bg-gray-50 dark:bg-slate-700 p-6 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="200">
              <FaQuoteLeft className="text-3xl text-purple-300 mb-4" />
              <p className="text-slate-600 dark:text-slate-300 mb-6 italic">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-slate-800 dark:text-white">Sarah Patel</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400">Interior Designer</p>
                </div>
              </div>
            </div>
            
            {/* Testimonial 3 */}
            <div className="bg-gray-50 dark:bg-slate-700 p-6 rounded-2xl shadow-lg" data-aos="fade-up" data-aos-delay="300">
              <FaQuoteLeft className="text-3xl text-purple-300 mb-4" />
              <p className="text-slate-600 dark:text-slate-300 mb-6 italic">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-slate-800 dark:text-white">Anil Kumar</h4>
