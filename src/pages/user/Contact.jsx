...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-16">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-purple-600 to-violet-600 py-20 overflow-hidden">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                  <div className="w-14 h-14 bg-violet-100 rounded-xl flex items-center justify-center mb-4">
                    <FaPhoneAlt className="text-2xl text-violet-600" />
                  </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                  <div className="w-14 h-14 bg-violet-100 rounded-xl flex items-center justify-center mb-4">
                    <FaClock className="text-2xl text-violet-600" />
                  </div>
        ...
        <div className="container">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            <div className="bg-gray-50 rounded-xl p-6" data-aos="fade-up" data-aos-delay="100">
              <h3 className="text-lg font-semibold text-slate-800 mb-2">What are your delivery options?</h3>
              <p className="text-slate-600">We offer free delivery within the city limits. For outstation deliveries, we work with trusted logistics partners to ensure safe and timely delivery.</p>
            </div>
            
            <div className="bg-gray-50 rounded-xl p-6" data-aos="fade-up" data-aos-delay="200">
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Do you provide installation services?</h3>
              <p className="text-slate-600">Yes, we have a team of experienced professionals who can handle the installation of tiles at your premises. Contact us for more details.</p>
            </div>
            
            <div className="bg-gray-50 rounded-xl p-6" data-aos="fade-up" data-aos-delay="300">
              <h3 className="text-lg font-semibold text-slate-800 mb-2">What is your return policy?</h3>
              <p className="text-slate-600">We offer a 7-day return policy for unused tiles in their original packaging. Please refer to our terms and conditions for detailed information.</p>
            </div>
            
            <div className="bg-gray-50 rounded-xl p-6" data-aos="fade-up" data-aos-delay="400">
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Do you offer bulk discounts?</h3>
              <p className="text-slate-600">Yes, we offer competitive pricing for bulk orders. Please contact our sales team for a customized quote based on your requirements.</p>
            </div>
          </div>
        </div>
      </div>
