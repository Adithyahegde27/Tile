             ...
             gap-6 items-center">
                ...
                <div data-aos="zoom-in">
                    <img src={BannerImg} alt="" 
                     ...
                     mx-auto drop-shadow-[-10px_10px_12px_rgba(0,0
                     0,1)] object-cover"
                    />
                </div>
                ...
                <div className="flex flex-col justify-center gap-6 sm:pt-0">
                    <h1 data-aos="fade-up" className="text-3xl sm:text-4xl font-bold">
                        Special sale upto 40% off
                    </h1>
                    <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-5">
                        Our collection includes ceramic, vitrified, marble, and designer tiles crafted to enhance every interior and exterior.
                    </p>
